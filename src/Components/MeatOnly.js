...
export default function MeatOnly({ name, bread, pumpkin, meats, sidings, appetiser, salad, freebies, cost, functionDate, number }) {
        ...
        <div>
            <div id="quotation-content" style={{ fontFamily: 'Arial, sans-serif', color: '#333', lineHeight: '1.6', padding: '20px', border: '1px solid #ddd', borderRadius: '10px', width: '800px', margin: 'auto', backgroundColor: 'white' }}>
                ...
                <div style={{ margin: '20px 30px' }}>
                    ...
                    <p style={{ textDecoration: 'underline', fontWeight: 'bold' }}>Additional Notes</p>
                    <p>{freebies}</p>
